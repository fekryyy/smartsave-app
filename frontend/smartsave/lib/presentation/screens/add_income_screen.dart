                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('Add Income', style: TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: textCol, letterSpacing: -0.5)),
                          const SizedBox(height: 2),
                          Text('Record your earnings', style: TextStyle(fontSize: 13, color: hintCol)),
                        ]),
                        GestureDetector(
                      ...
                      // === SOURCE ===
                      Text('Income Source', style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: sectionCol, letterSpacing: 0.3)),
                      const SizedBox(height: 12),
                      CategorySelector(
                        categories: AppConstants.incomeSources,
                        selected: _selectedSource,
                        onChanged: (v) => setState(() => _selectedSource = v),
                        icons: _mapSourceIcons(),
                        categoryColors: _mapSourceColors(),
                      ),
                      const SizedBox(height: 24),
                  ...
                  child: TweenAnimationBuilder<double>(
                    ...
                    builder: (ctx, value, _) => Transform.scale(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        Text('Income Added!', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w700, color: textCol)),
                      ]),
                    ),
                  ),
                ),
